package com.estudo.pizzaplanet.controllers;

import com.estudo.pizzaplanet.dto.*;
import com.estudo.pizzaplanet.service.ProductService;
...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<RecoveryProductDto> createProduct(@RequestBody CreateProductDto createProductDto){
    ...
    public ResponseEntity<RecoveryProductDto> createProductVariation(@PathVariable Long productId,
        ...
        return new ResponseEntity<>(productService.createProductVariation(productId, createProductVariationDto), HttpStatus.CREATED);
    }
